...
;; Version: $Id: bm.el,v 1.32 2006/03/09 21:19:31 jood Exp $
...
(defconst bm-version "$Id: bm.el,v 1.32 2006/03/09 21:19:31 jood Exp $"
...
(defun bm-show nil
  ...
  (if (= (bm-count) 0)
	...
	(setq buffer-read-only t)
      ...
      ;; brian
      (shrink-window-if-larger-than-buffer (get-buffer-window "*bm-bookmarks*"))
      )))
